...
open class XYButton @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) : AppCompatButton(ContextThemeWrapper(context, R.style.xy_button), attrs, defStyle) {
